...
3. **TC-04** - Проверка отправки сообщения через форму обратной связи (`ContactUsTest`)
3. **TC-04** - Проверка отправки сообщения через форму Дистанционное открытие счета (`OnbordingTest`)
